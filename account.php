...
<title>Quiz || Sathya Sai Samiti Online Quiz </title>
...
<div class="row">
<div class="col-lg-7">
<span class="logo">Sri Sathya Sai Seva Organisation | Online Quiz</span></div>
...
echo '<div class="panel panel-info"><div class="panel-heading">Quiz Info</div>';
    echo '<table class="table  table-bordered"><thread>
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Correct Answer</b></td><td style="vertical-align:middle"><b>Wrong Answer</b></td><td style="vertical-align:middle"><b>Total Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr></thread>';
    $c = 1;
  ...
  <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></span></a></b></td></tr>';
    ...
    $c = 0;
    echo '</table></div><div class="panel" style="padding-top:1px;padding-left:15%;padding-right:15%;word-wrap:break-word"><h3 align="center" style="font-family:calibri"><div class="alert alert-info" role="alert"> :: General Instructions ::</div></h3><br /><ul type="circle"><font style="font-size:14px;font-family:calibri">';
...
<center><h1 class="title" style="color:#660033">Result</h1><center><br /><table class="table table-striped title1 table-bordered" style="font-size:20px;font-weight:1000;">';
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    echo '</table></div>';
    echo '<div class="panel title"><table class="table table-striped title1 table-bordered" ><tr>';
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by Sathya Sai Samiti,Gangtok<br><br></span></div>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')" target="new">About sathya Sai</a></div>
</div>
</body>
</html>
