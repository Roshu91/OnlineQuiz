...
<title> Sathya Sai Samiti Online Quiz  </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Sri Sathya Sai Seva Organisation</span><br/><span class="logo"><span class="glyphicon glyphicon-education" ></span> Online Quiz</span></div>
...
<div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>
  <input id="username" name="username" placeholder="Username" class="form-control input-md" type="username"></div>
...
<div class="col-md-4 panel panel-info well well-lg"> 

<div class="panel-heading"><i class="glyphicon glyphicon-pencil"></i> <b> Participation Form </b></div>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About Sathya Sai Samiti</a></div>
</div>
...
<div class="form-group">
 <div class="input-group">
<div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>
<input type="text" name="uname" maxlength="20"  placeholder="Username" class="form-control"/> </div>
</div>
<div class="form-group">
 <div class="input-group">
<div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
<input type="password" name="password" maxlength="30" placeholder="Password" class="form-control"/></div>
</div>
